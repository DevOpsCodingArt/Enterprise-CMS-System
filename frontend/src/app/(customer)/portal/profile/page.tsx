  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-card border-border shadow-xs overflow-hidden">
        {/* Top Hero Section with Large Square Avatar (Button Removed) */}
        ...
        {/* Integrated 2-Column Details: Personal & Installation Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border">
          {/* Column A: Personal & Identity Information (with GPS Coordinates) */}
          ...
          {/* Column B: Technical Installation & Network Hardware Details */}
          <div className="p-6 space-y-4">
