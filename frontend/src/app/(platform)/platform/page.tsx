    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
        <div className="bg-card rounded-xl border border-border p-4 shadow-xs">
          ...
          <div className="text-xs text-success mt-0.5 font-medium flex items-center gap-1">
        ...
        <div className="bg-card rounded-xl border border-border p-4 shadow-xs">
          ...
          <div className="text-xs text-muted-foreground mt-0.5">Across {totalBranches} Regional Hubs</div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border p-4 shadow-xs">
          ...
          <div className="text-xs text-muted-foreground mt-0.5">ARR: {formatCurrencyPKR(totalMrr * 12)} (+18% QoQ)</div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border p-4 shadow-xs">
          ...
          <div className="text-xs text-muted-foreground mt-0.5">
            Ping: <span className="font-mono font-medium text-success">{systemMetrics.apiGatewayLatencyMs}ms (Healthy)</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-card rounded-xl border border-border shadow-xs overflow-hidden flex flex-col justify-between">
                      ...
                      <td className="p-3.5">
                        <div className="font-heading font-semibold text-foreground text-sm flex items-center gap-1.5">
                          <span
                            ...
                            style={{ backgroundColor: t.primaryColor || 'var(--primary)' }}
                          />
                          {t.name}
                        </div>
                        <div className="text-xs font-mono text-primary mt-0.5">{t.subdomain}</div>
                      </td>
          ...
          <div className="p-3.5 bg-muted/20 border-t border-border/70 text-xs text-muted-foreground flex justify-between items-center">
            ...
            <span className="font-mono text-success font-medium">100% Data Isolation</span>
          </div>
        </div>
          ...
          <div className="bg-card rounded-xl border border-border p-5 shadow-xs space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div className="flex justify-between items-center">
                ...
                <span className="font-mono font-medium text-success">12,400 msg/sec</span>
              </div>
              <div className="flex justify-between items-center">
