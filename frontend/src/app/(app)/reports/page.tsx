    ...
    <div className="p-6 max-w-7xl mx-auto w-full space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
        <div className="bg-card rounded-xl border border-border p-4 shadow-xs">
          <div className="text-xs text-muted-foreground font-medium">Total Chats (This Month)</div>
          <div className="font-mono font-bold text-2xl mt-1 text-primary">{reports.totalChatsMonth.toLocaleString()}</div>
          <div className="text-xs text-muted-foreground mt-0.5">+14% vs last month</div>
        </div>

        <div className="bg-card rounded-xl border border-border p-4 shadow-xs">
          <div className="text-xs text-muted-foreground font-medium">First Response Time (FRT)</div>
          <div className="font-mono font-bold text-2xl mt-1 text-info-foreground dark:text-info">{reports.frtSeconds} Seconds</div>
          <div className="text-xs text-success mt-0.5 font-medium">Target: &lt; 60s ✓</div>
        </div>

        <div className="bg-card rounded-xl border border-border p-4 shadow-xs">
          <div className="text-xs text-muted-foreground font-medium">Mean Time to Resolve (MTTR)</div>
          <div className="font-mono font-bold text-2xl mt-1 text-foreground">{reports.mttrMinutes} Mins</div>
          <div className="text-xs text-muted-foreground mt-0.5">80% 1st-level resolution</div>
        </div>

        <div className="bg-card rounded-xl border border-border p-4 shadow-xs">
          <div className="text-xs text-muted-foreground font-medium">CSAT Rating Average</div>
          <div className="font-mono font-bold text-2xl mt-1 text-warning">{reports.csatRating} / 5.0</div>
          <div className="text-xs text-warning mt-0.5 font-medium">★★★★★ ({reports.positivePercentage}% positive)</div>
        </div>
      </div>
          ...
          <div className="space-y-3 text-xs">
            <div>
              ...
              <div className="w-full bg-muted/40 rounded-full border border-border/70 h-2.5 overflow-hidden">
                <div className="bg-primary rounded-full h-full w-11/12" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-muted/40 rounded-full border border-border/70 h-2.5 overflow-hidden">
                <div className="bg-info rounded-full h-full w-1/12" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-muted/40 rounded-full border border-border/70 h-2.5 overflow-hidden">
                <div className="bg-warning rounded-full h-full w-1" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-muted/40 rounded-full border border-border/70 h-2.5 overflow-hidden">
                <div className="bg-destructive rounded-full h-full w-1" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 rounded-lg bg-muted/30 border border-border/70 flex justify-between items-center">
              <div>
                ...
                <div className="text-xs text-muted-foreground">Fiber cuts & morning billing enquiries</div>
              </div>
            ...
            <div className="p-3 rounded-lg bg-muted/30 border border-border/70 flex justify-between items-center">
              <div>
                ...
                <div className="text-xs text-muted-foreground">Streaming buffer, gaming latency & speed tests</div>
              </div>
            ...
            <div className="p-3 rounded-lg bg-muted/30 border border-border/70 flex justify-between items-center">
              <div>
                ...
                <div className="text-xs text-muted-foreground">Core NOC maintenance & autonomous bot triage</div>
              </div>
