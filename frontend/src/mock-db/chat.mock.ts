    ...
    messages: [
      {
        ...
        content: 'Hello, the red light is blinking on my fiber router in F-10/2.',
        createdAt: '04:15 AM',
        status: 'read',
      },
      {
        ...
        content: 'Hello Zayan. Let me inspect your optical signal link in our SmartOLT telemetry right now.',
        createdAt: '04:18 AM',
        status: 'read',
      },
      {
