...
export const permissionCategories = pgTable(
  ...
  (table) => [index('idx_perm_categories_company').on(table.companyId)],
);
...
export const permissions = pgTable(
  ...
  (table) => [
    index('idx_permissions_category').on(table.categoryId),
    uniqueIndex('idx_permissions_slug').on(table.slug),
  ],
);
...
export const permissionGroups = pgTable(
  ...
  (table) => [index('idx_perm_groups_company').on(table.companyId)],
);
...
export const permissionGroupPermissions = pgTable(
  ...
  (table) => [index('idx_group_perms_group').on(table.permissionGroupId)],
);
...
export const userPermissionGroups = pgTable(
  ...
  (table) => [index('idx_user_groups_user').on(table.userId)],
);
...
export const userPermissionOverrides = pgTable(
  ...
  (table) => [index('idx_user_overrides_user').on(table.userId)],
);
