...
export const loginHistory = pgTable(
  ...
  (table) => [
    index('idx_login_user').on(table.userId, table.createdAt),
    index('idx_login_customer').on(table.customerId, table.createdAt),
    index('idx_login_company').on(table.companyId, table.createdAt),
  ],
);
...
export const companySettings = pgTable(
  ...
  (table) => [index('idx_settings_company_key').on(table.companyId, table.key)],
);
